//
//  OnlyOriginalViewController.m
//  DMLPhotoBrowserDemo
//
//  Created by 戴明亮 on 2018/1/2.
//  Copyright © 2018年 戴明亮. All rights reserved.
//

#import "OnlyOriginalViewController.h"
...
@interface OnlyOriginalViewController ()
...
@implementation OnlyOriginalViewController
...
- (void)imageClick:(UIGestureRecognizer *)gesture
{
    ...
    for (NSString *url in self.originalURLs) {
        ...
        NSURL *originalImageURL = [NSURL URLWithString:url];

        DMLPhotoItem *item = [[DMLPhotoItem alloc] initWithOriginalImageURL:originalImageURL];
